...
def inference(images):
  ...
  with tf.variable_scope('conv2') as scope:
    ...
    #conv2 = tf.sigmoid(bias, name=scope.name)
  ...
  with tf.variable_scope('local4') as scope:
    ...
    #local4 = tf.tanh(tf.matmul(local3, weights) + biases, name=scope.name)
    #local4 = tf.sigmoid(tf.matmul(local3, weights) + biases, name=scope.name)
