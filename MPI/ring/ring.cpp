...
int main(int argc, char* argv[])
{
    ...
    if (id == 0) {
        ...
        MPI::COMM_WORLD.Recv(msg, MSG_BUFF_SIZE, MPI::CHAR, size - 1, 0, status);
        sleepy_print(id, "Received: ", msg);
    }
    ...
    if (id != 0) {
        ...
        sleepy_print(id, "Received: ", msg);
        int target_id = (id + 1 >= size) ? 0 : id + 1;
        sleepy_print(id, "Sending: ", msg);
        MPI::COMM_WORLD.Send(msg, MSG_BUFF_SIZE, MPI::CHAR, target_id, 0);
    }
